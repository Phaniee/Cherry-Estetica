             ...
             <tr> 
              ...
              <td class="text-center">
                  <form action="process.php" method="POST">
                    ...
                    <input type="hidden" class="form-control" id="id" name="id" value="<?=$User['codUser']?>">
                    <button type="submit" class="dropdown-item"><i class="fas fa-edit fa-lg text-secondary"></i>
                    </button>
                  </form>
                </td>
                <td class="text-center">
                  <a class="dropdown-item" onclick="modalRemover(<?=$User['codUser']?>,'idDeletar')">
