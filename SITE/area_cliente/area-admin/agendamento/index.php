<?php 
  ...
  $agendamentos = AgendamentoDao::selectAllWithClientes();
...
<head>
  ...
  <title>Cherry Estética - Agendamentos</title>
      ...
      <div class="col-md-10  p-4 borber">
        <div class="row align-items-center mb-4">
          <div class="col fs-4 fw-semibold">
            Lista de Agendamentos - Cherry Estética
          </div>
          ...
          <table class="table table-hover">
            <thead>
              <tr>
                ...
                <th class="col-md-1">Cod Serviço</th>
              ...
              <?php foreach($agendamentos as $agendamento): ?>
                <tr> 
                  ...
                  <td><?= $agendamento['codServico']; ?></td>
                  <td><?= $agendamento['nomeCliente']; ?></td>
                  <td class="text-center">
                    <form action="process.php" method="POST">
                      <input type="hidden" class="form-control" id="acao" name="acao" value="SELECTID">
                      <input type="hidden" class="form-control" id="id" name="id" value="<?= $agendamento['codAgendamento']; ?>">
                      <button type="submit" class="dropdown-item"><i class="fas fa-edit fa-lg text-secondary"></i></button>
                    </form>
                  </td>
                  <td class="text-center">
                  <a class="dropdown-item" onclick="modalRemover(<?= $agendamento['codAgendamento'];?>,'idDeletar')">
