      ...
      <div class="col-md-10  p-4 borber">
        <div class="row align-items-center mb-4">
          <div class="col fs-4 fw-semibold">
            Lista de Clientes - Cherry Estética
          </div>
          ...
          <table class="table table-hover">
            <thead>
              <tr>
                ...
                <th class="text-center col-md-2">Visualizar e Alterar</th>
             ...
             <tr> 
              ...
              <td class="text-center">
                  <form action="process.php" method="POST">
                    ...
                    <input type="hidden" class="form-control" id="id" name="id" value="<?=$Cliente['codCliente']?>">
                    <button type="submit" class="dropdown-item"><i class="fas fa-edit fa-lg text-secondary"></i>
                    </button>
                  </form>
                </td>
                <td class="text-center">
                  <a class="dropdown-item" onclick="modalRemover(<?=$Cliente['codCliente']?>,'idDeletar')">
