      ...
      <div class="col-md-10  p-4 borber">
        <div class="row align-items-center mb-4">
          <div class="col fs-3 fw-semibold">
            Lista de Serviços - Cherry Estética
          </div>
          ...
          <table class="table table-hover">
            <thead>
             ...
             <tr> 
              ...
              <td><?=$Servico['duracaoServico'];?></td>
              <td><?=$Servico['descricaoServico'];?></td>
              <td class="text-center">
                  <form action="process.php" method="POST">
                    <input type="hidden" class="form-control" id="acao" name="acao" value="SELECTID">
                    <input type="hidden" class="form-control" id="id" name="id" value="<?=$Servico['codServico']?>">
                    <button type="submit" class="dropdown-item"><i class="fas fa-edit fa-lg text-secondary"></i>
                    </button>
                  </form>
                </td>
                <td class="text-center">
                  <a class="dropdown-item" onclick="modalRemover(<?=$Servico['codServico']?>,'idDeletar')">
