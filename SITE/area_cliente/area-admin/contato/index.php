      ...
      <div class="col-md-10  p-4 borber">
        <div class="row align-items-center mb-4">
          <div class="col fs-4 fw-semibold">
            Lista de Contatos - Cherry Estética
          </div>
          ...
          <table class="table table-hover">
            <thead>
              ...
              <?php foreach ($contato as $Contato) : ?>
                <tr>
                  <td><?= $Contato['codContato']; ?></td>
                  <td><?= $Contato['nomeContato']; ?></td>
                  <td><?= $Contato['emailContato']; ?></td>
                  <td><?= $Contato['categoriaContato']; ?></td>
                  <td><?= $Contato['comentarioContato']; ?></td>
                  <td class="text-center">
                    <form action="process.php" method="POST">
                      <input type="hidden" class="form-control" id="acao" name="acao" value="SELECTID">
                      <input type="hidden" class="form-control" id="id" name="id" value="<?= $Contato['codContato'] ?>">
                      <button type="submit" class="dropdown-item"><i class="fas fa-edit fa-lg text-secondary"></i>
                      </button>
                    </form>
                  </td>
                  <td class="text-center">
                    <a class="dropdown-item" onclick="modalRemover(<?= $Contato['codContato'] ?>,'idDeletar')">
